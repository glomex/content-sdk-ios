...
POD_NAME=GlomexContentSdk
PODSPEC=GlomexContentSdk.podspec
...
if [ ! -f "$RELEASE_NOTES" ]; then
    ...
    RELEASE_NOTES=/tmp/GlomexContentSdk.release.notes
...
open "https://github.com/glomex/content-sdk-ios/releases/new?tag=$VERSION_TAG"
